...
namespace Nhom_247.Controller
{
    internal class Showtimes_Controller
    {
        ...
        {
            string conStr = "INSERT INTO Showtimes VALUES (@ID_Movie,@ID_Room, @MovieName, @TIME, @DATE)";
        ...
        {
            string conStr = "UPDATE Showtimes SET MovieName = @MovieName, TIME = @TIME WHERE ID_Movie = @id";
            MySqlConnection conn = GetConnection();
            MySqlCommand cmd = new MySqlCommand(conStr, conn);
            cmd.CommandType = CommandType.Text;
        ...
        {
            string conStr = "DELETE FROM Showtimes WHERE ID_Movie = @ID";
            MySqlConnection conn = GetConnection();
            MySqlCommand cmd = new MySqlCommand(conStr, conn);
            cmd.CommandType = CommandType.Text;
